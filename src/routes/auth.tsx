...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Secure staff portal for Nandan Kids Higher Secondary School." },
    ],
  }),
});
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 text-primary-foreground" style={{ backgroundImage: "var(--gradient-primary)" }}>
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-semibold tracking-tight">
            Manage your school<br />with clarity and care.
          </h1>
          <p className="text-primary-foreground/80 max-w-md">
            A unified platform for admissions, attendance, fees, examinations
            and reporting — designed for Indian schools.
          </p>
        </div>
