...
const reports = [
  ...
  { title: "Fee collection", desc: "Daily, monthly and term-wise fee collection.", icon: Wallet },
  {
    ...
    desc: "Student and class attendance percentages.",
    icon: CalendarCheck,
  },
  {
    title: "Exam performance",
    desc: "Subject-wise averages, toppers and pass %.",
    icon: ClipboardList,
  },
  { title: "Fee dues", desc: "Outstanding fee list per student.", icon: BarChart3 },
  {
    title: "Teacher workload",
    desc: "Class assignment and workload distribution.",
    icon: BarChart3,
  },
];
...
function ReportsPage() {
  return (
    <div>
      <PageHeader
        title="Reports"
        description="Generate reports required by school administration and board."
      />
